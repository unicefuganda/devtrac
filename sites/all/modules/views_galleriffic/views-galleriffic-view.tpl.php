<?php
// $Id: views-galleriffic-view.tpl.php,v 1.1.2.8 2010/06/11 15:11:01 acouch Exp $
/**
 * @file
...
if (!file_exists($file_path)) {
  drupal_set_message('The Views Galleriffic module requires the <a href="http://www.twospy.com/galleriffic/js/jquery.galleriffic.js">Galleriffic JS</a> file. Download and place in the \'modules/views_galleriffic/js/\' folder.');
}
