 ...
 * @version    1.0.0
 */
class WURFL_Xml_PersistanceProvider_MemcachePersistanceProvider extends WURFL_Xml_PersistanceProvider_AbstractPersistanceProvider {

	const EXTENSION_MODULE_NAME = "memcache";
	const DEFAULT_HOST = "127.0.0.1";
	const DEFAULT_PORT = 11211;
	
	protected $persistanceIdentifier = "MEMCACHE_PERSISTANCE_PROVIDER";
	...
	private function _ensureModuleExistance() {
		if(!extension_loaded(self::EXTENSION_MODULE_NAME)) {
			throw new WURFL_Xml_PersistanceProvider_Exception("The PHP extension memcache must be installed and loaded in order to use the Memcached.");
		}
	}
