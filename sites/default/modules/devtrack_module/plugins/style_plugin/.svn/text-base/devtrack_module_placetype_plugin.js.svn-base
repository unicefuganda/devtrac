 ...
 * Style context class
 */
Drupal.openlayers.style_plugin.devtrack_module_placetype_plugin = function (params) {
 ...
 */
Drupal.openlayers.style_plugin.devtrack_module_placetype_plugin.prototype = {
