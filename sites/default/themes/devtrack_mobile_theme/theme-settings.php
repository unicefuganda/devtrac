...
function devtrack_mobile_theme_settings($saved_settings) {
  // Load color.inc to get the base color
  require_once "color/color.inc";
  if (!isset($saved_settings['devtrack_mobile_theme_native']) || !(module_exists('mobileplugin'))) {
    $saved_settings['devtrack_mobile_theme_native'] = 1;
  }
  ...
  $form['recognition']['devtrack_mobile_theme_native'] = array(
    '#type'          => 'checkbox',
    ...
    '#default_value' => $saved_settings['devtrack_mobile_theme_native'],
