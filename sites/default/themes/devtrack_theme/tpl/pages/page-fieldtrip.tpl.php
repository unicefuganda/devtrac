...
<div class="container">
  ...
  <div id="contentcontainer" class="span-24 last">
    ...
    <?php
      if ($tabs != '') {
        print '<div class="tabsaslist"><div class="tabsaslist-title">Field Trip</div>'. $tabs .'</div>';
      }
      print $help; // Drupal already wraps this one in a class      

//      print $content;  // Content is shown by the Field Trip Content Block
      print $feed_icons;
    ?>
    ...
    <?php  if (arg(2)) {?>
    <div class="col-content_contentlayerright span-18 last">
    <?php 
      print $content;  // Content is shown by the Field Trip Content Block
    ?>
    </div>
  ...
  <?php if ($layeroneleft | $layeronemiddle | $layeroneright): ?> 
  ...
  <?php if ($layertwoleft | $layertworight): ?> 
