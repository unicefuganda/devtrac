...
<div class="container">
  ...
  <div class="<?php print $center_classes; ?>">
    ...
    <div class="contentlayer clearfix">
    <div class="col-content_contentlayerleft span-16">
    ...
    <?php
      ...
      if ($tabs != '') {
        print '<div class="tabsaslist">'. $tabs .'</div>';
      }

      if ($messages != '') {
        print '<div id="messages">'. $messages .'</div>';
      }
      print $contentlayerleft;  // here is where the about box goes :-)
      if ($title != '') {
        print '<h2>'. $title .'</h2>';
      }      
